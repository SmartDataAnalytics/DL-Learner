...
public class InstanceNode extends Node{
	...
	public  Set<String> toNTriple(){
		...
		s.add("<"+this.URI+"><"+"http://www.w3.org/1999/02/22-rdf-syntax-ns#type"+"><"+"http://www.w3.org/2002/07/owl#Thing"+">.");
		for (ClassNode one:classes){
			s.add("<"+this.URI+"><"+"http://www.w3.org/1999/02/22-rdf-syntax-ns#type"+"><"+one.getURI()+">.");
