...
//TODO COMMENT !!! added a sample java call class for the dl-learner (as a possible entry point for tool developers)
public class Sample {
	...
	public List<Description> learn(){
		...
		// This method is a workaround, it should be like the two commented lines below
