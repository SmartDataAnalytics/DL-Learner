...
public class ExpressionEditor<O> extends JTextPane implements VerifiedInputEditor{
    ...
    private Map<String, Color> keywordColorMap = new KeywordColorMap();
    ...
    public ExpressionEditor(OREManager mngr, OWLExpressionChecker<O> checker) {
        this.mngr = mngr;
        ...
        new OWLAutoCompleter(mngr, this, checker);
...
//        new OWLExpressionHistoryCompleter(owlEditorKit, this);
            ...
            public void run() {
                try {
                    ...
                    while (tokenizer.hasMoreTokens()) {
                        ...
                        if (!inEscapedName) {
                            Color color = keywordColorMap.get(curToken);
                            if (color == null) {
                                color = Color.BLACK;
                            }
    ...
    private void createStyles() {
        for (Color color : keywordColorMap.values()) {
