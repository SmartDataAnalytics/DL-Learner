...
public class ConfWriter {
	...
	public void writeROLLearnerOWLFileInd(String filename,SortedSet<Individual> pos,SortedSet<Individual> neg,
			String owlFile, SortedSet<String> ignoredConcepts){
		
		writeROLLearnerOWLFile( filename,toString( pos),toString( neg),
				 owlFile,  ignoredConcepts);
	}
	
	public void writeROLLearnerOWLFile(String filename,SortedSet<String> pos,SortedSet<String> neg,
				String owlFile, SortedSet<String> ignoredConcepts){
	...
	public void writeSPARQL(String filename,SortedSet<String> pos,SortedSet<String> neg,
			...
			String standardSettings="sparql.recursionDepth = 1;\n" +
