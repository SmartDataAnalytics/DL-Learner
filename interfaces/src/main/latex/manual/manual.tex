...
\begin{description}
 ...
 \end{itemize}
 \item[SPARQL Reasoner] Combined with the SPARQL endpoint or an OWLFile through a Jena Model, instance checks can be translated into SPARQL queries. This requires that the SPARQL endpoint contains the necessary OWL statements and entailments. (See \cite{sparqllearner} for details.)
