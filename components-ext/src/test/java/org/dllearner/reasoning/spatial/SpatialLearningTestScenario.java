...
//        spatialReasoner.setIsContainmentRelationReflexive(true);
    ...
    /**
     * Target class expression: Feature and (isNear some AreaFeature)
     */
    private static void runScenario2() throws ComponentInitException {
        String exampleFilePath =
                SpatialLearningTestScenario.class.getClassLoader()
                        .getResource("example_data.owl").getFile();
        KnowledgeSource ks = new OWLFile(exampleFilePath);
        ...
        spatialReasoner.init();
        spatialReasoner.setNearRadiusInMeters(85);
//        spatialReasoner.setIsContainmentRelationReflexive(true);
