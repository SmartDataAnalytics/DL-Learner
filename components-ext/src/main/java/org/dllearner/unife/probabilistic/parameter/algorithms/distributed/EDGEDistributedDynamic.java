...
public class EDGEDistributedDynamic extends AbstractEDGEDistributed {
    ...
    @ConfigOption(name = "chunkDim", defaultValue = "1", description = "number of example for chunk")
    private int chunkDim = 1;

    @ConfigOption(name = "maxSenderThreads", description = " max number of concurrent threads which send examples to the slaves", defaultValue = "#processors - 1")
