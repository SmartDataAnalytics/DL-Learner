 ...
 */
package org.dllearner.unife.probabilistic.structure.algorithms.distributed;
...
import org.dllearner.unife.probabilistic.distributed.core.CommunicatorGroupNotAssignedException;
import org.dllearner.unife.probabilistic.distributed.core.DistributedComponent;
...
public class LEAPDistributed extends AbstractPSLA implements DistributedComponent {
    ...
    @ConfigOption(name = "differenceLL", description = "stop difference between log-likelihood of two consecutive iterations", defaultValue = "0.00001")
    private BigDecimal differenceLL = MathUtilities.getBigDecimal(0.00001, 5);

    private BigDecimal currentDifferenceLL;

    @ConfigOption(name = "ratioLL", description = "stop ratio between log-likelihood of two consecutive iterations", defaultValue = "0.00001")
    private BigDecimal ratioLL = MathUtilities.getBigDecimal(0.00001, 5);

    private BigDecimal currentRatioLL;

    @ConfigOption(name = "maxIterations", description = "maximum number of iterations", defaultValue = "2147000000")
    ...
    @ConfigOption(name = "targetAxiomsFilename", description = "probabilistic target axioms which can be deleted from the ontology")
    ...
    @ConfigOption(name = "procPSLA", description = "number of mpi processes of probabilistic structure learning algorithm", defaultValue = "1")
    private int procPSLA = 1;

    @ConfigOption(name = "procPLA", description = "number of mpi processes of parameter learning algorithm for each probabilistic structure learner process", defaultValue = "1")
...
//        }
        ...
        if (learningProblem instanceof PosNegLP) {
            ...
            negativeIndividuals = Sets.difference(learningProblem.getReasoner().getIndividuals(), positiveIndividuals).immutableCopy();
