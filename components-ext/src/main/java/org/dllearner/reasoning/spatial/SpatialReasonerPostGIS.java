...
public class SpatialReasonerPostGIS extends AbstractReasonerComponent implements SpatialReasoner {
    ...
    protected SortedSet<OWLObjectProperty> getSuperPropertiesImpl(OWLObjectProperty objectProperty) {
        ...
        } else if (objectProperty.equals(SpatialVocabulary.hasTangentialProperPart)) {
            superProperties.add(SpatialVocabulary.isConnectedWith);
            superProperties.add(SpatialVocabulary.overlapsWith);
            superProperties.add(SpatialVocabulary.hasPart);
    ...
    protected Map<OWLIndividual, SortedSet<OWLIndividual>> getPropertyMembersImpl(
        ...
        if (SpatialVocabulary.spatialObjectProperties.contains(objectProperty)) {
            ...
            // hasTangentialProperPart
                ...
                return getHasTangentialProperPartMembers();

            // hasNonTangentialProperPart
            } else if (objectProperty.equals(SpatialVocabulary.hasNonTangentialProperPart)) {
                return getHasNonTangentialProperPartMembers();
...
//
    ...
    protected Map<OWLIndividual, SortedSet<OWLIndividual>> getStartsNearMembers() {
        String queryStr =
            ...
            "FROM " +
                ...
                pointFeatureTableName + " r " +
            "WHERE " +
                "ST_DWithin(ST_StartPoint(l.the_geom), r.the_geom, ?, false) " +  // #1
            "UNION " +
            "SELECT " +
                "l.iri l_iri, " +
                "r.iri r_iri " +
            "FROM " +
                ...
                lineFeatureTableName + " r " +
            "WHERE " +
                "ST_DWithin(ST_StartPoint(l.the_geom), r.the_geom, ?, false) " +  // #2
            "AND " +
                "NOT l.the_geom=r.the_geom " +
            "UNION " +
            "SELECT " +
    ...
    protected SortedSet<OWLIndividual> getIndividualsOWLObjectSomeValuesFrom(
        ...
        if ((prop instanceof OWLObjectProperty)
            ...
            // isSpatiallyIdenticalWith
            } else if (prop.equals(SpatialVocabulary.isSpatiallyIdenticalWith)) {
                Set<OWLIndividual> individuals = new HashSet<>();
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    Set<OWLIndividual> indivsSpatiallyIdenticalWFillerIndiv =
                            getIndividualsSpatiallyIdenticalWith(fillerIndiv)
                                    .collect(Collectors.toSet());

                    individuals.addAll(indivsSpatiallyIdenticalWFillerIndiv);
                }

                return new TreeSet<>(individuals);

            // hasTangentialProperPart
            } else if (prop.equals(SpatialVocabulary.hasTangentialProperPart)) {
                Set<OWLIndividual> individuals = new HashSet<>();
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    Set<OWLIndividual> indivsHavingFillerIndivAsTangentialProperPart =
                            getIndividualsHavingTangentialProperPart(fillerIndiv)
                                    .collect(Collectors.toSet());

                    individuals.addAll(indivsHavingFillerIndivAsTangentialProperPart);
                }
            ...
            // hasNonTangentialProperPart
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    Set<OWLIndividual> indivsHavingFillerIndivAsNonTangentialProperPart =
                            getIndividualsHavingNonTangentialProperPart(fillerIndiv)
                                    .collect(Collectors.toSet());

                    individuals.addAll(indivsHavingFillerIndivAsNonTangentialProperPart);
                }
            ...
            // isDisconnectedFrom
            } else if (prop.equals(SpatialVocabulary.isDisconnectedFrom)) {
                Set<OWLIndividual> individuals = new HashSet<>();
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    Set<OWLIndividual> indivsDisconnectedFromFillerIndiv =
                            getIndividualsDisconnectedFrom(fillerIndiv)
                                    .collect(Collectors.toSet());

                    individuals.addAll(indivsDisconnectedFromFillerIndiv);
                }
            ...
            // isNear
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    Set<OWLIndividual> indivsNearFillerIndiv =
                            getIndividualsNear(fillerIndiv)
                                    .collect(Collectors.toSet());

                    individuals.addAll(indivsNearFillerIndiv);
                }
            ...
            // endsNear
            } else if (prop.equals(SpatialVocabulary.endsNear)) {
                Set<OWLIndividual> individuals = new HashSet<>();
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    Set<OWLIndividual> indivsEndingNearFillerIndiv =
                            getIndividualsEndingNear(fillerIndiv)
                                    .collect(Collectors.toSet());

                    individuals.addAll(indivsEndingNearFillerIndiv);
                }
        ...
        if ((prop instanceof OWLObjectProperty)
            ...
            // isSpatiallyIdenticalWith
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    updateCounterMap(individualsWCounts, indivsSpatiallyIdenticalWFillerIndiv);
                }
            ...
            // hasTangentialProperPart
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    updateCounterMap(individualsWCounts, indivsHavingFillerIndivAsTangentialProperPart);
                }
            ...
            // hasNonTangentialProperPart
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    updateCounterMap(individualsWCounts, indivsHavingFillerIndivAsNonTangentialProperPart);
                }
            ...
            // isDisconnectedFrom
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    updateCounterMap(individualsWCounts, indivsDisconnectedFromFillerIndiv);
                }
            ...
            // isNear
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    Set<OWLIndividual> indivsNearFillerIndiv =
                            getIndividualsNear(fillerIndiv).collect(Collectors.toSet());
            ...
            // endsNear
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    updateCounterMap(individualsWCounts, indivsEndingNearFillerIndiv);
                }
    ...
    protected SortedSet<OWLIndividual> getIndividualsOWLObjectAllValuesFrom(
        ...
        if ((prop instanceof OWLObjectProperty)
            ...
            // isSpatiallyIdenticalWith
                ...
                // All individuals are instances of
                // \forall :spatiallyIdenticalWith <filler>
                // as long as they aren't spatially identical with something not
                // being of type <filler>
                Set<OWLIndividual> resultIndividuals = new HashSet<>();

                for (Map.Entry<OWLIndividual, SortedSet<OWLIndividual>> entry :
                        getIsSpatiallyIdenticalWithMembers().entrySet()) {
            ...
            // hasTangentialProperPart
                ...
                for (Map.Entry<OWLIndividual, SortedSet<OWLIndividual>> entry :
                        getHasTangentialProperPartMembers().entrySet()) {
            ...
            // hasNonTangentialProperPart
                ...
                for (Map.Entry<OWLIndividual, SortedSet<OWLIndividual>> entry :
                        getHasNonTangentialProperPartMembers().entrySet()) {
            ...
            // isDisconnectedFrom
                ...
                // All individuals are instances of
                // \forall :isDisconnectedFrom <filler>
                // as long as they aren't disconnected from an individual
                // not being of type <filler>
                Set<OWLIndividual> resultIndividuals = new HashSet<>();

                for (Map.Entry<OWLIndividual, SortedSet<OWLIndividual>> entry :
                        getIsDisconnectedFromMembers().entrySet()) {
            ...
            // isNear
                ...
                // All individuals are instances of
                // \forall :isNear <filler>
                // as long as they aren't near an individual not being of
                // type <filler>
                Set<OWLIndividual> resultIndividuals = new HashSet<>();
            ...
            // endsNear
                ...
                // All individuals are instances of
                // \forall :endsNear <filler>
                // as long as they don't end near an individual not being of
                // type <filler>
                Set<OWLIndividual> resultIndividuals = new HashSet<>();

                for (Map.Entry<OWLIndividual, SortedSet<OWLIndividual>> entry :
                        getEndsNearMembers().entrySet()) {
        ...
        if ((prop instanceof OWLObjectProperty)
            ...
            // hasNonTangentialProperPart
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    updateCounterMap(
                            individualsWCounts,
                            indivsHavingFillerIndivAsNonTangentialProperPart);
                }
            ...
            // isDisconnectedFrom
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    updateCounterMap(
                            individualsWCounts,
                            indivsDisconnectedFromFillerIndiv);
                }
            ...
            // endsNear
                ...
                for (OWLIndividual fillerIndiv : fillerIndivs) {
                    ...
                    Set<OWLIndividual> indivsEndingNearFillerIndiv =
                            getIndividualsEndingNear(fillerIndiv).collect(Collectors.toSet());

                    updateCounterMap(
                            individualsWCounts,
                            indivsEndingNearFillerIndiv);
                }
