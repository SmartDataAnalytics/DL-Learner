...
import org.dllearner.algorithm.tbsl.sem.dudes.data.Argument;
import org.dllearner.algorithm.tbsl.sem.dudes.data.Dude;
import org.dllearner.algorithm.tbsl.sem.util.CompositeType;
import org.dllearner.algorithm.tbsl.sem.util.DomType;
import org.dllearner.algorithm.tbsl.sem.util.DominanceConstraint;
import org.dllearner.algorithm.tbsl.sem.util.ElemType;
import org.dllearner.algorithm.tbsl.sem.util.ElementaryType;
    ...
    if (jj_2_29(2)) {
      ...
      drs2 = DRS();
        ...
        drs.setScope(drs2);
                ...
                if (quantifier.toString().equals("THEMOST")) {drs.setQuantifier(DRS_Quantifier.THE_MOST);}
                if (quantifier.toString().equals("THELEAST")) {drs.setQuantifier(DRS_Quantifier.THE_LEAST);}
                ...
                if (quantifier.toString().equals("HOWMANY")) {drs.setQuantifier(DRS_Quantifier.HOW_MANY);}
