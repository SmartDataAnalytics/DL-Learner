...
public class Config {
	...
	// Problem: dieser Parameter hat für GP und Refinement zwar die gleiche Bedeutung,
	...
	// bei Refinement in flexible heuristic soll es so sein, dass schlechtere Konzepte
	// probiert werden sollen, sobald horizontal expansion eines gut klassifizierenden
	// Knotens steigt => da ist also gewünscht das kürzere aber schlechtere Knoten
	// ev. einen Vorsprung haben => demzufolge ist dort ein hoher Wert (ca. 0.05)
	// angebracht
	// public static double percentPerLengthUnit = 0.0025;
	public static double percentPerLengthUnit = 0.05;
	
	public enum Algorithm {GP, BRUTE_FORCE, RANDOM_GUESSER, REFINEMENT, HYBRID_GP};
	...
	// an-/abschalten von System.nanoTime()-Aufrufen außerhalb des Reasoningservice
	...
	// TODO: noch nicht implementiert, dass man diese per Config-Datei setzen kann
	public static class Refinement {
		...
		public enum UseDIGMultiInstanceChecks { NEVER, TWOCHECKS, ONECHECK };
		...
		// weniger Kommunikation; Nachteil: es müssen alle instanceChecks ausgeführt
		...
		// Konzepte, die in der Definition vorkommen können (per Default ("null") alle)
		// nicht implementiert
		...
		// beachte: es können nur entweder die erlaubten oder die ignorierten Konzepte
		// gesetzt werden
		
		// true falls die Konzepte vom Nutzer gesetzt worden (also allowedConcepts
	...
	public static class GP {
		...
		// bei true werden statt Disjunction MultiDisjunction und statt Conjunction
		// MultiConjunction im GP benutzt (es gibt derzeit keinen Grund es auf false
		// zu setzen)
