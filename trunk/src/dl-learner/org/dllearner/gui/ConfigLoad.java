...
public class ConfigLoad {
	...
	if (this.file.exists()) {
	    ...
	    // KNOWLEDGE SOURCE
	    // filename
	    String value = parser.getFunctionCalls().get("import").get(0)
		    .get(0);
	...
	if (!value.startsWith("http://") && !value.startsWith("file://"))
	    value = "file://".concat(file.getPath().replace(file.getName(), "")
		    .concat(value));
	return value;
    }
