...
public class SparqlHTTPRequest {
	...
	public String makeContent(String query) {
		...
		try {
			...
			RequestHeader += "" + SparqlEndpoint.getHasQueryParameter() + "="
			...
			RequestHeader += "Connection: close"
					...
					+ cut
					+ "User-Agent: Mozilla/5.0 (Windows; U; Windows NT 5.1; de; rv:1.8.1.4) Gecko/20070515 Firefox/2.0.0.4 Web-Sniffer/1.0.24"
					+ cut + cut;
		} catch (Exception e) {
			e.printStackTrace();
		}
