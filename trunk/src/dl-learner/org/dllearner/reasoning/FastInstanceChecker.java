 ...
 * base to speed up later reasoning requests. It then continues by only considering one
...
public class FastInstanceChecker extends ReasonerComponent {
	...
	.getLogger(FastInstanceChecker.class);	
	...
	public boolean instanceCheck(Description description, Individual individual) throws ReasoningMethodUnsupportedException {
		if(description instanceof NamedClass) {
			...
			if(child instanceof NamedClass) {
				...
				throw new ReasoningMethodUnsupportedException("Instance check for description " + description + " unsupported. Description needs to be in negation normal form.");
			}
