...
<div style="margin: 3px;">
<div>
<input type="checkbox" id="checkboxMethodTwoInput1" name="checkboxMethodTwoInput[0]" value="1" checked="checked" />
<label for="checkboxMethodTwoInput1">Checkbox Method 2 Input 1</label>
</div>
<div>
<input type="checkbox" id="checkboxMethodTwoInput2" name="checkboxMethodTwoInput[1]" value="2" checked="checked" />
<label for="checkboxMethodTwoInput2">Checkbox Method 2 Input 2</label>
</div>
<div>
<input type="checkbox" id="checkboxMethodTwoInput3" name="checkboxMethodTwoInput[3]" value="4" checked="checked" />
