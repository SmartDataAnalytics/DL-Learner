...
//						SortedSet<Individual> tmp = rs.getIndividuals(upperClass);
						...
						// added by Josue - fuzzy extension
						...
						while (itCandidate.hasNext()) {
							if (((FuzzyIndividual)itCandidate.next()).compareTo((FuzzyIndividual)itCandidate.next()) != 0) {
								meaningful = true;
								break;
							}
						}
						// tmp.removeAll(rs.getFuzzyIndividuals(candidate));
