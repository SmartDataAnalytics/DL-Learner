 ...
 * 
 */
public class PADCELCoverageGreedyReducer implements PADCELReducer {
	...
	public SortedSet<PADCELExtraNode> compact(SortedSet<PADCELExtraNode> partialDefinitions,
		...
		TreeSet<PADCELExtraNode> minimisedPartialDefinition = new TreeSet<PADCELExtraNode>(
				new PADCELCorrectnessComparator());

		Iterator<PADCELExtraNode> partialDefinitionIterator = partialDefinitions.iterator();
