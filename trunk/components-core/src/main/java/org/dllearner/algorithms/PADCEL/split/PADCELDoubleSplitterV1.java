...
import org.dllearner.algorithms.PADCEL.PADCELOntologyUtil;
...
@ComponentAnn(name = "pdll double splitter v2", shortName = "pdlldsv2", version = 0.08)
public class PADCELDoubleSplitterV1 implements PADCELDoubleSplitterAbstract {
	 ...
	 */
	public PADCELDoubleSplitterV1(AbstractReasonerComponent reasoner,
	...
	public void init() throws ComponentInitException {
		...
		try {
			ontology = PADCELOntologyUtil.loadOntology(ontologyPath);
