...
import org.dllearner.dl.AssertionalAxiom;
...
import org.dllearner.dl.InverseRoleAxiom;
...
public class KAON2Reasoner extends AbstractReasoner {
	...
	public KAON2Reasoner(KB kb, Map<URL,org.dllearner.OntologyFileFormat> imports) {
	...
	*/
	...
	public Map<org.dllearner.dl.Individual, SortedSet<org.dllearner.dl.Individual>> getRoleMembers(AtomicRole atomicRole) {
		...
		try {
			...
			while (!query.afterLast()) {
				tupleBuffer = query.tupleBuffer();
				org.dllearner.dl.Individual individual1 = new org.dllearner.dl.Individual(tupleBuffer[0].toString());
				org.dllearner.dl.Individual individual2 = new org.dllearner.dl.Individual(tupleBuffer[1].toString());
	...
	public void saveOntology(File file, org.dllearner.OntologyFileFormat format) {
		// File exportFile = new File(baseDir, fileName);
		// String format = OntologyFileFormat.OWL_RDF;
		String kaon2Format = "";
		if(format.equals(org.dllearner.OntologyFileFormat.RDF_XML))
	...
	private static Ontology importKB(String ontologyURI, org.dllearner.OntologyFileFormat format, KAON2Connection connection) {
		Ontology ontology = null;
		try {
			long importStartTime = System.currentTimeMillis();
			ontology = connection.openOntology(ontologyURI, new HashMap<String, Object>());
