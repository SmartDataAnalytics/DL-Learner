...
//			"   font-family: monospace;" +
	...
	@Override
	protected void beginTable(StringBuilder sb) {
...
//				+ "<th data-valign='middle'>Query Graph</th>\n"
	...
	@Override
	protected void addRow(StringBuilder sb, QueryData queryData) {
		sb.append("<tr>\n");
...
//		sb.append("<td><img src=\"" + graphFile.getPath() + "\" alt=\"query graph\"></td>\n");
		...
		DescriptiveStatistics genericCBDSizeStats = queryData.determineDefaultCBDSizes;
	...
	@Override
	protected void endTable(StringBuilder sb) {
		sb.append("</tbody>\n</table>\n");
	}
