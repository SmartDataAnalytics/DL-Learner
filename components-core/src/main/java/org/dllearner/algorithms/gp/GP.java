...
//    private OWLClassExpression bestConcept;
//    
...
//        	Set<Entry<OWLClassExpression,ScorePosNeg>> entrySet = psi.evalCache.entrySet();
//        	for(Entry<OWLClassExpression,ScorePosNeg> entry : entrySet) {
//        		ScorePosNeg tmpScore = entry.getValue();
//        		OWLClassExpression c = entry.getKey();
//        		tmpScore = tmpScore.getModifiedLengthScore(OWLClassExpressionUtils.getLength(c));
...
//        	System.out.println("misclassifications: " + misClassifications + ", length " + OWLClassExpressionUtils.getLength(bestConcept));
//        }
//          
//        /*
...
//        OWLClassExpression n = fittestIndividual.getTree();
//
...
//        System.out.println("highest fitness: " + fittestIndividual.getFitness() + " ["+misClassifications+" misclassifcations, length "+OWLClassExpressionUtils.getLength(n)+"]");
//        
...
//        for(Program p : individuals)
//        	conceptLengthSum += OWLClassExpressionUtils.getLength(p.getTree());
