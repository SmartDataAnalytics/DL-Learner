...
public class ParCELExCombineCounterPartialDefinition {
	...
	public static Set<ParCELExtraNode> getCombinable(ParCELNode description,
		...
		Set<ParCELExtraNode> combinableCounterPartialDefinitions = new HashSet<ParCELExtraNode>();
		...
		HashSet<OWLIndividual> coveredNegativeExamples = new HashSet<OWLIndividual>();
		coveredNegativeExamples.addAll(description.getCoveredNegativeExamples());
