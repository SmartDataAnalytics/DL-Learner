...
public class TCELOE extends AbstractCELA implements Cloneable{

	private static final Logger logger = LoggerFactory.getLogger(TCELOE.class);
...
//	private OEHeuristicRuntime heuristicRuntime = new OEHeuristicRuntime();
	...
	public TCELOE(AbstractClassExpressionLearningProblem problem, AbstractReasonerComponent reasoner) {
...
//							System.out.println("candidates: " + startClassCandidates);
	...
	private OENode getNextNodeToExpand() {
		...
		t = Math.max(0, maxT - this.numReturnedNodes);
