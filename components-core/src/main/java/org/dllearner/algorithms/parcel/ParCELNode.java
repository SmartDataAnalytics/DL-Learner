...
public class ParCELNode extends OENode {
	...
	protected Set<OWLIndividual> coveredPositiveExamples = new HashSet<OWLIndividual>();
	protected Set<OWLIndividual> coveredNegativeExamples = new HashSet<OWLIndividual>();
	...
	*/
	...
	public String toString() {
		String ret = this.getDescription().toString();
