 ...
 */
public class SimpleLocalBeamSearch
        extends LocalBeamSearch<OWLClassExpression, ClassScore, EvaluatedDescriptionClass> {
...
//        hypothesis.setDescription(hypothesis.getDescription());
    ...
    @Override
    protected double utility(EvaluatedDescriptionClass hypothesis, EvaluatedDescriptionClass parent) {
        // quality gain
    ...
    @Override
    protected double quality(EvaluatedDescriptionClass hypothesis) {
...
//        System.exit(0);
        ...
        SimpleLocalBeamSearch alg = new SimpleLocalBeamSearch(10, Sets.newHashSet(startClass), rc, op, lp);
        alg.search();
